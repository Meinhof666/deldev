...
<body>
    ...
    <section class="header">
        <div class="header__list">
            ...
            <div class="header__items header__right">
                ...
                <a href="announc.php" class="header__btn">
                    <div class="header__item">
                    <svg fill="currentColor" viewBox="0 0 16 16" width="16" height="16">
    ...
    <section class="main__content">
        <div class="main__item search">
            <div class="chapters">
                <div class="chapter__title">
                    <h2>Категории Д<span>Д</span></h2>
                </div>
        ...
        <div class="main__item for__you">
            <div class="for__you__content">
                <a href="profile.php">
                    <div class="for__you__item">
                        <div class="for__you__title">
                            <h3>Моя недвижемость</h3>
                            <p>Единый сервис для вашего дома</p>
                        </div>
                        <div class="for__you__img">
                            <img src="assets/img/myned.png">
                        </div>
                    </div>
                </a>
                <a href="announc.php">
                    <div class="for__you__item">
                        <div class="for__you__title">
                            ...
                            <p>О продаже или сдачи в аренду</p>
                        </div>
                        <div class="for__you__img">
                            <img src="assets/img/razmes.png">
                        </div>
                    </div>
                </a>
            </div>
            <div class="adv">
                <a href="announc.php">
                    <div class="for__you__item adv__item">Реклама</div>
                </a>
            </div>
        </div>
        <div class="main__item content">
        </div>
        <div class="main__item advert">
